...
def update(operation_name = "", duration = ""):
    return [operation_name, duration]

def get_operation_name(node):
    """ Gets the function name when scanning
    """
    global operation_data = (operation_name = "",duration = "")
